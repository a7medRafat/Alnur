...
class AppFunctions {
  ...
  static Future<bool> handleLocationPermission(context) async {
    ...
    CacheHelper.saveData(key: 'enabled', value: serviceEnabled);
    if (!serviceEnabled) {
      MyToast.show(
  ...
  static Future<Placemark> getAddressFromLatLng(
    ...
    try {
      ...
      CacheHelper.saveData(key: 'country', value: place.country);
      CacheHelper.saveData(key: 'city', value: place.administrativeArea);
      return place;
    } catch (e) {
